...
| **Automation** | A cron-dispatched recurring skill execution with cadence policy and pause/resume lifecycle. | [Skill System](domain/skill-system/index.md) |
...
| **Capability** | A unit of agent functionality (e.g., `task_create`, `email_draft`) with defined tool access and autonomy level. | [Agents](domain/agents.md), [Skill System](domain/skill-system/index.md) |
